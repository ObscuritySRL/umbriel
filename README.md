...
The MCP server exposes **63 snapshot-first tools** (57 under the default `safe` profile; 23 under `readonly`; the 6 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
