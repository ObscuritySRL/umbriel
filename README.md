...
The MCP server exposes **66 snapshot-first tools** (59 under the default `safe` profile; 25 under `readonly`; the 7 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
