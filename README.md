...
The MCP server exposes **64 snapshot-first tools** (58 under the default `safe` profile; 24 under `readonly`; the 6 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
