...
The MCP server exposes **94 snapshot-first tools** (72 under the default `safe` profile; 38 under `readonly`; the 22 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
