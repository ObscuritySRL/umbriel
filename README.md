...
The MCP server exposes **76 snapshot-first tools** (60 under the default `safe` profile; 26 under `readonly`; the 16 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
