...
The MCP server exposes **95 snapshot-first tools** (73 under the default `safe` profile; 39 under `readonly`; the 22 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
