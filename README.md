...
The MCP server exposes **78 snapshot-first tools** (61 under the default `safe` profile; 27 under `readonly`; the 17 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
