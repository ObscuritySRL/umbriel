...
The MCP server exposes **96 snapshot-first tools** (73 under the default `safe` profile; 39 under `readonly`; the 23 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
