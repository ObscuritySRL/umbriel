...
The MCP server exposes **84 snapshot-first tools** (65 under the default `safe` profile; 31 under `readonly`; the 19 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
