...
The MCP server exposes **61 snapshot-first tools** (55 under the default `safe` profile; 22 under `readonly`; the 6 os/fs tools need `full` or `UMBRIEL_OS=1`) behind a deployer policy you control:
