...
ARTICLE.md is gitignored (".gitignore: Local-only dev docs — never publish", alongside CLAUDE-FABLE-5.md /
DISCORD_POST.md) — not tracked, not in package.json `files`, not published. Its "Current version is 1.11.1" was a
