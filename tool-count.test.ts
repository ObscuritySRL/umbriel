...
test('packages/skry/README.md quotes the live tool counts', async () => {
...
test('packages/skry/README.md quotes the live tool counts', async () => {
  const readme = await Bun.file(`${import.meta.dir}/../skry/README.md`).text();
...
test('packages/skry/AI.md quotes the live tool counts', async () => {
